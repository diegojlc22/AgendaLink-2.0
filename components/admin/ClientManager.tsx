                ...
                <div className="space-y-2">
                    {state.clients.map(client => (
                        <button 
                            ...
                            className={`w-full text-left p-3 rounded-lg transition-colors ${selectedClient?.id === client.id ? 'bg-primary text-white' : 'bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                        >
                ...
                {selectedClient ? (
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <button onClick={() => handleResetPassword(selectedClient.id)} className="btn-secondary text-white text-sm font-bold py-1 px-3 rounded">Resetar Senha</button>
                        </div>
